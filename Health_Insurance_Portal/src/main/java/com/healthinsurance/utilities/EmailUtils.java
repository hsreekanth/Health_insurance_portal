...
public class EmailUtils {
	...
	public  boolean sendUserAccUnlockEmail(RegisterUserEntity reg)  {
...
return isSent;
	...
	public String getUnlockAccEmailBody(RegisterUserEntity reg) throws IOException {
			...
			mailBody = mailBody.replace("{TEMP-PWD}", reg.getPazzword());
